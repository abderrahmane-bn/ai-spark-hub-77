      ...
      {pastWithResources.length === 0 ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {pastWithResources.map((w) => (
            <div key={w.id} className="group rounded-2xl border border-border/60 bg-card overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-0.5">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border/60">
                  ...
                  <button className="flex items-center gap-1.5 rounded-xl gradient-primary px-4 py-2 text-xs font-semibold text-primary-foreground transition-all hover:scale-105 shadow-glow">
